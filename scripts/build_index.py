...
CASE_STUDIES: list[dict] = [
    ...
    {
        "n": 6, "slug": "permutation", "name": "Permutation Tests",
        ...
        "tags": ["permutation test", "statistical inference", "null model", "randomization", "p-value", "significance", "case study 06"],
    },
    {
        "n": 7, "slug": "counterfactual", "name": "Counterfactual Inference",
        ...
        "tags": ["counterfactual", "what if", "intervention", "causal", "decision", "policy", "case study 07"],
    },
    {
        "n": 8, "slug": "gnn-by-hand", "name": "Graph Neural Networks by Hand",
        ...
        "tags": ["GNN", "graph neural network", "message passing", "neighborhood aggregation", "by hand", "from scratch", "case study 08"],
    },
    {
        "n": 9, "slug": "gnn-xgboost", "name": "GNN + XGBoost for Prediction",
        ...
        "tags": ["GNN", "XGBoost", "gradient boosting", "node prediction", "embeddings", "machine learning", "supplier failure", "case study 09"],
    },
    {
        "n": 10, "slug": "dsm-clustering", "name": "DSM & Clustering",
        ...
        "tags": ["DSM", "design structure matrix", "clustering", "community detection", "modularity", "Louvain", "subsystems", "case study 10"],
    },
    {
        "n": 11, "slug": "sampling", "name": "Network Sampling",
        ...
        "tags": ["sampling", "snowball", "random walk", "induced subgraph", "big networks", "scaling", "case study 11"],
    },
]
